...
class CalendarViewController: UIViewController, FSCalendarDelegate, FSCalendarDataSource {
    ...
    private func setupCalendar() {
        ...
        calendar.appearance.headerTitleColor = ThemeColor.today4
        calendar.appearance.todayColor = ThemeColor.today4.withAlphaComponent(0.5)
        calendar.appearance.selectionColor = ThemeColor.today4
        calendar.appearance.weekdayTextColor = ThemeColor.today4
